...
CREATE TABLE IF NOT EXISTS metrics_daily (
    instrument_token   BIGINT NOT NULL,
    trade_date         DATE NOT NULL,
    ret_1d DOUBLE, ret_1w DOUBLE, ret_2w DOUBLE, ret_3w DOUBLE,
    ret_1m DOUBLE, ret_2m DOUBLE, ret_3m_2m DOUBLE,
    ...
    -- FR-14: pullback to support with reversal confirmation
    support_level DOUBLE,
    support_distance_pct DOUBLE,
    is_at_support BOOLEAN,
    pullback_from_high_pct DOUBLE,
    reversal_score INTEGER,
    is_reversal BOOLEAN,
    is_pullback_reversal BOOLEAN,
